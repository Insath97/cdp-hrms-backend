    ...
    public function getImportableConfig(): array
    {
        return [
            ...
            'designations' => [
                ...
                'fillable' => ['name', 'code', 'department_id', 'monthly_target', 'basic_salary', 'travel_reimbursement', 'vehicle_rental', 'performance_allowance', 'incentive', 'position_allowance', 'mobile_payment', 'total_package', 'level', 'is_active'],
            ],
            'employees' => [
